...
const scrollUpSvgPath = document.querySelector('.scroll-up__svg-path'); //если кнопка с закрашиванием по мере скролла
const pathLength = scrollUpSvgPath.getTotalLength(); //если кнопка с закрашиванием по мере скролла

scrollUpSvgPath.style.strokeDasharray = `${pathLength} ${pathLength}`;
scrollUpSvgPath.style.transition = 'stroke-dasharray 20ms';
