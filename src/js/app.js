...
/*
Модуль для анимации при скролле
Добавляем к блоку класс_anim-items для анимации объекта при скрлле, и если хотим, 
чтобы при обратном скролле наверх анимация не повторялась, 
то дополнительно класс  _anim-no-hide
Не забываем про css. Пример стилей для анимации
*класс анмируемого объекта{
...
*/
//flsFunctions.animeScroll();
/*
Модуль для работы с кнопкой Наверх
*/
